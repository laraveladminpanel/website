  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
        <h2 class="section-heading text-uppercase">Screenshots</h2>
        <h3 class="section-subheading text-muted">Examples of the visual part of the admin panel.</h3>
      </div>
    </div>
    <div class="row">
      <div class="col-md-4 col-sm-6 portfolio-item">
        ...
        <div class="portfolio-caption">
          <h4>CRUD</h4>
          <p class="text-muted">Creating CRUD</p>
        </div>
      </div>
      <div class="col-md-4 col-sm-6 portfolio-item">
        ...
        <div class="portfolio-caption">
          <h4>Role</h4>
          <p class="text-muted">Role Management</p>
        </div>
      </div>
      <div class="col-md-4 col-sm-6 portfolio-item">
        ...
        <div class="portfolio-caption">
          <h4>Media</h4>
          <p class="text-muted">File manager</p>
        </div>
      </div>
      <div class="col-md-4 col-sm-6 portfolio-item">
        ...
        <div class="portfolio-caption">
          <h4>Menu</h4>
          <p class="text-muted">Menu Builder</p>
        </div>
      </div>
      <div class="col-md-4 col-sm-6 portfolio-item">
        ...
        <div class="portfolio-caption">
          <h4>Posts</h4>
          <p class="text-muted">Posts edit</p>
        </div>
      </div>
      <div class="col-md-4 col-sm-6 portfolio-item">
        ...
        <div class="portfolio-caption">
          <h4>Roles</h4>
          <p class="text-muted">Creating Roles</p>
        </div>
      </div>
    </div>
  </div>
